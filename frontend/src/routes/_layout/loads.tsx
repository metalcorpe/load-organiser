...
export const Route = createFileRoute("/_layout/loads")({
  component: LoadsPage,
})
          ...
          <DialogBody>
            {showOptimizer && selectedLoad ? (
              <LoadOptimizer
                ...
                currentJumpers={selectedLoad.jumps || []}
    ...
    >
      <Flex justify="space-between" align="start">
        <VStack align="start" gap={2} flex={1}>
          <HStack gap={3}>
            <Text fontWeight="semibold">Load #{load.id.substring(0, 8)}</Text>
            <Badge colorScheme={getStatusColor(load.status)} variant="subtle">
